...
export const translations: Record<string, Translations> = {
  es: {
    ...
    'portfolio.project2.title': 'App de Gestión Empresarial',
    'portfolio.project2.tech': 'React, Python, PostgreSQL',
    'portfolio.project2.description': 'Aplicación web para gestión de recursos humanos, finanzas y operaciones empresariales.',
    'portfolio.project3.title': 'Dashboard Analítico',
    'portfolio.project3.tech': 'Vue.js, D3.js, Express',
    'portfolio.project3.description': 'Panel de control interactivo con visualizaciones de datos en tiempo real y reportes personalizables.',
  ...
  en: {
    ...
    'portfolio.project2.title': 'Business Management App',
    'portfolio.project2.tech': 'React, Python, PostgreSQL',
    'portfolio.project2.description': 'Web application for human resources, finance and business operations management.',
    'portfolio.project3.title': 'Analytics Dashboard',
    'portfolio.project3.tech': 'Vue.js, D3.js, Express',
    'portfolio.project3.description': 'Interactive control panel with real-time data visualizations and customizable reports.',
  ...
  pt: {
    ...
    'portfolio.project2.title': 'App de Gestão Empresarial',
    'portfolio.project2.tech': 'React, Python, PostgreSQL',
    'portfolio.project2.description': 'Aplicação web para gestão de recursos humanos, finanças e operações empresariais.',
    'portfolio.project3.title': 'Dashboard Analítico',
    'portfolio.project3.tech': 'Vue.js, D3.js, Express',
    'portfolio.project3.description': 'Painel de controle interativo com visualizações de dados em tempo real e relatórios personalizáveis.',
  ...
  fr: {
    ...
    'portfolio.project2.title': 'Application de Gestion d\'Entreprise',
    'portfolio.project2.tech': 'React, Python, PostgreSQL',
    'portfolio.project2.description': 'Application web pour la gestion des ressources humaines, des finances et des opérations commerciales.',
    'portfolio.project3.title': 'Tableau de Bord Analytique',
    'portfolio.project3.tech': 'Vue.js, D3.js, Express',
    'portfolio.project3.description': 'Panneau de contrôle interactif avec visualisations de données en temps réel et rapports personnalisables.',
  ...
  de: {
    ...
    'portfolio.project2.title': 'Geschäftsmanagement-App',
    'portfolio.project2.tech': 'React, Python, PostgreSQL',
    'portfolio.project2.description': 'Webanwendung für Personal-, Finanz- und Geschäftsbetriebsmanagement.',
    'portfolio.project3.title': 'Analytics-Dashboard',
    'portfolio.project3.tech': 'Vue.js, D3.js, Express',
    'portfolio.project3.description': 'Interaktives Kontrollpanel mit Echtzeit-Datenvisualisierungen und anpassbaren Berichten.',
  ...
  it: {
    ...
    'portfolio.project2.title': 'App di Gestione Aziendale',
    'portfolio.project2.tech': 'React, Python, PostgreSQL',
    'portfolio.project2.description': 'Applicazione web per la gestione delle risorse umane, finanze e operazioni aziendali.',
    'portfolio.project3.title': 'Dashboard Analitico',
    'portfolio.project3.tech': 'Vue.js, D3.js, Express',
    'portfolio.project3.description': 'Pannello di controllo interattivo con visualizzazioni dati in tempo reale e report personalizzabili.',
